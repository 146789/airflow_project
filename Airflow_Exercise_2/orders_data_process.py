...
def main(date):
    ...
    # gs://airflow-projetcs-1/airflow_project2/data/orders_20241213.csv
    # Define the path where the files are located
    input_path = f"gs://airflow-projetcs-1/airflow_project2/data/orders_{date}.csv"
    ...
    output_path = f"gs://airflow-projetcs-1/airflow_project2/output/processed_orders_{date}"
